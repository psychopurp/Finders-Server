...
type CommunityUser struct {
	...
	UserID      null.String `gorm:"column:user_id;type:VARCHAR;size:30;" json:"user_id"` //[ 1] user_id                                        VARCHAR[30]          null: true   primary: false  auto: false
	CommunityID null.Int    `gorm:"column:community_id;type:INT;" json:"community_id"`   //[ 4] community_id                                   INT                  null: true   primary: false  auto: false
	Status      null.Int    `gorm:"column:status;type:INT;" json:"status"`               //[ 5] status                                         INT                  null: true   primary: false  auto: false
